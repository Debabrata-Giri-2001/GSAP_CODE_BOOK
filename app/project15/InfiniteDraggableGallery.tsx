...
const InfiniteDraggableGallery = () => {
    ...
    useGSAP(() => {
        ...
        const projectTitleElement: any = document.querySelector(".project-title p");
        ...
        function updateSettings() {
            ...
            visibleItems.forEach((itemId: any) => {
        ...
        function setAndAnimateTitle(title: any) {
        ...
        function getItemSize(row: any, col: any) {
        ...
        function getItemId(col: any, row: any) {
            return `${col},${row}`;
        }
        // Get the absolute position for an item
        function getItemPosition(col: any, row: any) {
        ...
        function handleItemClick(item: any, itemIndex: any) {
            if (isExpanded) {
        ...
        function expandItem(item: any, itemIndex: any) {
            isExpanded = true;
            activeItem = item;
        ...
        function closeExpandedItem() {
            ...
            const originalItem: any = document.getElementById(activeItemId);
            if (originalItem) {
                const nameElement: any = originalItem.querySelector(".item-name");
                const numberElement: any = originalItem.querySelector(".item-number");
            ...
            gsap.to(expandedItem, {
                ...
                onComplete: () => {
                    ...
                    if (originalItem) {
                        ...
                        captionClone.style.left = `${captionRect.left}px`;
                        captionClone.style.bottom = `${window.innerHeight - captionRect.bottom
                            }px`;
                        captionClone.style.width = `${captionRect.width}px`;
                        ...
                        const nameClone: any = captionClone.querySelector(".item-name");
                        const numberClone: any = captionClone.querySelector(".item-number");
        ...
        <div className='body15'>
            ...
            <div className="footer">
                ...
                <div className="links-section">
                    <p>Press <span className="key-hint">H</span> to toggle panel</p>
                </div>
