        ...
        <section>
            <div id="smooth-wrapper">
                <div id="smooth-content">
                    <header className='flex flex-row border-b-2 border-gray justify-between items-center pb-2'>
                        <div className="logo flex flex-row w-[150px] max-w-[40vh] invert">
                            <svg viewBox="0 0 370 100.34">
                                <g xmlns="http://www.w3.org/2000/svg" fill="#111" transform="matrix(.34923 0 0 .34923 -2.282 -2.195)">
                                    ...
                                    <clipPath id="b">
                                        <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#a" overflow="visible" />
                                    </clipPath>
                    ...
                    <section className="hero min-h-[100vh] pad-l">
                        ...
                        <div className="images grid grid-cols-4 gap-4 mt-8 text-center place-items-center">
                            <Image height={450} width={200} data-speed="clamp(2.4)" src='https://images.unsplash.com/photo-1530569673472-307dc017a82d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2ODM2NTUwMDA&ixlib=rb-4.0.3&q=80&w=400' alt='' />
                            <Image height={450} width={200} data-speed="clamp(1.8)" src='https://images.unsplash.com/photo-1439853949127-fa647821eba0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2ODM2NTQ5Njk&ixlib=rb-4.0.3&q=80&w=400' alt='' />
                            <Image height={450} width={200} data-speed="clamp(2.2)" src='https://images.unsplash.com/photo-1551376347-075b0121a65b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2ODM2NTQ5MTE&ixlib=rb-4.0.3&q=80&w=400' alt='' />
                            <Image height={450} width={200} data-speed="clamp(1.5)" src='https://images.unsplash.com/photo-1500817487388-039e623edc21?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2ODM2NTQ5MTE&ixlib=rb-4.0.3&q=80&w=400' alt='' />
                        </div>
                    </section>

                    <section className="spacer h-[35vh]">
                    </section>
                </div>
            </div>
        </section>
