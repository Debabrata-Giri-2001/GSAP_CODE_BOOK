...
const Card = ({ i, title, description, src, url, color, progress, range, targetScale, link }: any) => {
                    ...
                    <div className="relative w-[60%] h-full rounded-[25px] overflow-hidden">
                        ...
                        >
                            ...
                            <Image
                                ...
                                src="https://www.ignant.com/2023/03/25/ad2186-matthias-leidingers-photographic-exploration-of-awe-and-wonder/"
