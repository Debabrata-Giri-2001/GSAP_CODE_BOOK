...
import dotsBox from "../assets/images/dotsBox.svg";
import linkedin from "../assets/images/linkedin.svg";
import logo from "../assets/images/logo.svg";
import youTube from "../assets/images/youTube.svg";

//image's
import dotcard from "../assets/images/dots-card.png";
import dotheader from "../assets/images/dots-header.png";

// video's
import cyber_risk_assessment from "../assets/videos/cyber_risk_assessment.mp4";

// export file
export { arrow, dotsBox, linkedin, logo, youTube };
export { dotcard, dotheader };
export { cyber_risk_assessment };
...
export const cardsData: Card[] = [
    { title: "Card One", description: "Lorem ipsum..." },
    { title: "Card Two", description: "More text..." },
    { title: "Card Three", description: "Third card..." },
    { title: "Card four", description: "Third card..." },
    { title: "Card five", description: "Third rygiwyet ye4 card..." },
];