  ...
  return (
    <div className='body14'>
      <section className="cloneable">
        <a data-draw-line="" href="#" className="text-draw w-inline-block">
          <p className="text-draw__p">Branding</p>
          <div data-draw-line-box="" className="text-draw__box"><svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 310 41" fill="none" preserveAspectRatio="none" className="text-draw__box-svg">
        ...
        <a data-draw-line="" href="#" className="text-draw w-inline-block">
          <p className="text-draw__p">Design</p>
          <div data-draw-line-box="" className="text-draw__box"></div>
        </a>
        <a data-draw-line="" href="#" className="text-draw w-inline-block">
          <p className="text-draw__p">Development</p>
          <div data-draw-line-box="" className="text-draw__box"></div>
        </a>
      </section>
      <div className="osmo-credits"></div>
    </div>
  )
}
